...
const changeLanguage = (event) => {
  i18nLocale.value = event.target.value
  locale.value = event.target.value
  router.post(route('locale.change', event.target.value))
}
        ...
        >
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                  ...
                  <LanguageSelector v-model="locale" :languages="languages" @change="changeLanguage"/>
